import withSortPopup from './hoc/withSortPopup';
...
const SortPopup = ({ sortBy, sortRef, setActiveAndClosePopup, visiblePopup, togglePopup }) => {
...
export default withSortPopup(SortPopup);
